 ...
 *
 * @param <DecryptedObjectType> The type of the object returned after the decryption process.
 * @param <DecryptionKey>       The type of the key required to perform the decryption process.
 */
public interface DecryptableSegment<DecryptedObjectType extends Serializable, DecryptionKey> extends Exportable {
     ...
     *
     * @param decryptionKey The key to decrypt the {@link DecryptableSegment} with.
     * @return The decrypted and deserialized {@link DecryptableSegment}.
     * @throws IllegalArgumentException If the provided key can't be used to decrypt the {@link DecryptableSegment}.
     */
