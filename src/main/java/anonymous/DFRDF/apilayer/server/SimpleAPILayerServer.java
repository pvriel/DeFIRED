...
import anonymous.DFRDF.apilayer.server.fileserver.FileServerInterface;
import anonymous.DFRDF.apilayer.server.fileserver.FileServerRequest;
import anonymous.DFRDF.apilayer.macaroon.APILayerMacaroon;
import anonymous.DFRDF.apilayer.macaroon.APILayerMacaroonManager;
...
import anonymous.DFRDF.applicationlayer.proof.ProofObject;
...
/**
 * Class representing the external server part of the {@link APILayer} class.
 * This class represents the {@link ReflectionMethodInvocationServer} instance for an {@link APILayer}
...
public class SimpleAPILayerServer extends TCPReflectionMethodInvocationServer {
    ...
    /**
     * Method to invoke a {@link FileServerInterface} method of the {@link APILayer}.
     * @param   macaroon
